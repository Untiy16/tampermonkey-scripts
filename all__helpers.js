...
//https://cdn.jsdelivr.net/gh/Untiy16/links@master/jquery-3.4.1-jQueryMod-noconflict.js
//https://untiy16.s-host.net/api/tampermonkey-scripts/jquery-3.4.1-jQueryMod-noconflict.js

let jQueryModScript= document.createElement('script');
jQueryModScript.setAttribute('src','https://untiy16.s-host.net/api/tampermonkey-scripts/jquery-3.4.1-jQueryMod-noconflict.js');
